...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            //     // Calculate last Sunday's date (end of last week)
            //     const lastSunday = new Date(today);
            //     lastSunday.setDate(today.getDate() - dayOfWeek);
            //     lastSunday.setHours(23, 59, 59, 999);
            
            //     // Calculate last Monday's date (start of last week)
            //     const lastMonday = new Date(lastSunday);
            //     lastMonday.setDate(lastSunday.getDate() - 6);
            //     lastMonday.setHours(0, 0, 0, 0);
        ...
        mounted() {
            ...
            fetch('https://lmthrp.com/api/kpi/countsign', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.mtdsigncount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/countmtd', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.mtdleadcount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/referredcount', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.referredcount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/rejectedcount', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.rejectedcount = data.response;
                });
                
        
              fetch('https://lmthrp.com/api/kpi/inhousesignupsummary', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.inhousesignupsummarycount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/categorysignupsummary', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.categorysignupsummarycount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/referredsummarycount', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.referredsummarycount = data.response;
                });
                
              fetch('https://lmthrp.com/api/kpi/inhousesignupsummarylist', CONFIG.HEADER)
                .then(res => res.json())
                .then(data => {
                    this.inhousesignupsummarylist = data.response;
                });
        }
    })
});
    ...
    <div class="container-fluid pt-3 pl-md-2 pr-md-2 pl-md-5 pr-md-5">
        ...
        <div>
            ...
            <div class="row profile-text">
                ...
                <h4 class="fw-300 mb-3">End-of-week Report - <b><?= date('M d, Y', strtotime('monday last week')) . ' - ' . date('M d, Y', strtotime('friday last week')); ?></b></h4>
                    ...
                    <div class="col-12 col-md-12 ml-auto">
                      <div class="dashboard-grid">
                        ...
                        <div class="dashboard-card">
                          ...
                          <h4>{{
                            mtdleadcount !== 0
                              ? (((mtdsigncount + referredcount) / mtdleadcount) * 100).toFixed(10)
                              : '0.0000000000'
                          }}%</h4>
                        </div>
                      </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md">
                        <h4 class="fw-300 mb-3">In-House Sign Up Summary</h4>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                      <th scope="col">Lead Source</th>
                                      <th scope="col">Sigh Ups</th>
                                    </tr>
                                </thead>
                                <tbody>
                    ...
                    <div class="col-md">
                        <h4 class="fw-300 mb-3">Category</h4>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                    ...
                    <div class="col-md">
                        <h4 class="fw-300 mb-3">Successful Referred Out</h4>
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
            ...
            <div class="row">
                <div class="col-md">
                    <h4 class="fw-300 mb-3">In-House Signup Details</h4>
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
            ...
            <div class="table-responsive">
                ...
                <h4 class="fw-300 mb-3">WEBSITE DEVELOPMENT</h4>
                <h5 class="fw-300 mb-3">Conclusions</h5>
                <h6 class="fw-300 mb-3">{{webdevEOW}}</h6>
                ...
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="card mb-4">
                        <div class="card-body">
                            <h5 class="fw-300 mb-3">Summary Report: End-Of-Week (EOW)</h5>
                            <p class="mb-1">Unique Team Members: <strong>{{ lastWeekData.uniquePerformers }}</strong></p>
                            
                            <div>
                            <p class="fw-bold mt-3">Counts per Report Type:</p>
                            <ul class="mb-0">
                                <li v-for="(count, report) in lastWeekData.reportCounts" :key="report">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <h5 class="fw-300 mb-3">Data Visualization: Reports This Week</h5>
